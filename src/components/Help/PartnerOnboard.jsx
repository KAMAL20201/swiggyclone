  ...
  return (
    <Container>
      <ul>
          ...
          <OnboardList
            ...
            content={
              <>
                ...
                - Cancelled Cheque OR bank Passbook <br />- Menu
              </>
            }
          />
        </li>
        ...
        <li>
          <OnboardList
            heading="What is this one time Onboarding fees? Do I have to pay for it while registering?"
        ...
        <li>
          <OnboardList
            heading="Who should I contact if I need help & support in getting onboarded?"
            content="You can connect with Partner Support on 080-67466777/68179777 or write to partnersuport@swiggy.in"
          />
        </li>
        <li>
          <OnboardList
            heading="How much commission will I be charged by Swiggy?"
        ...
        <li>
          <OnboardList
            heading="I don’t have an FSSAI licence for my restaurant. Can it still be onb"
